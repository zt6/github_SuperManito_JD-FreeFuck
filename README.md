...
ㅤ更新了配置文件，版本号到`3.32.5`，新增 "定义京喜农场控制推送通知级别" 控制脚本功能环境变量；更新了DIY脚本，新增部分活动。
...
> _注意：1. 此脚本为本人原创的一键更换国内更新源脚本，调用本人的另一个项目，之前附加在旧版本部署脚本中现独立出来，_\
> _ㅤㅤㅤ2. 如果您使用的平台位于国外则不需要执行此脚本，例如 `Google Cloud Platform` 用户，_\
