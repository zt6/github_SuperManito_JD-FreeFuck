...
##############################  作  者  脚  本  名  称  （必填）  ##############################
# 将相应作者的脚本填写到以下变量中
my_scripts_list_1="jd_entertainment.js jd_shakeBean.js jd_axc.js jd_xxl_gh.js jd_factory_component.js jd_marketLottery.js jd_superDay.js jd_xmf.js jd_wish.js  jd_technology_life.js"

## 活动脚本名称1：百变大咖秀、摇京豆、东东爱消除、个护爱消除、京喜工厂Plus、京东超市-大转盘、超级品类日、众筹许愿池、科技打造品质生活
...
sed -i "s|bash jd jd_technology_life|bash ${ShellDir}/jd.sh jd_technology_life|g" ${ListCron}
